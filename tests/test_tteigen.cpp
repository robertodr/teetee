...
TEST_CASE("refactor scaling", "[tt][eigen][scaling]") {
    auto A = tteigen::sample_tensor<5, 5, 5, 5, 5, 5>();
...
TEST_CASE("refactor left-multiplication by a scalar", "[tt][eigen][scalar-left-multiply]") {
    auto A = tteigen::sample_tensor<5, 5, 5, 5, 5, 5>();
...
TEST_CASE("refactor right-multiplication by a scalar", "[tt][eigen][scalar-right-multiply]") {
    auto A = tteigen::sample_tensor<5, 5, 5, 5, 5, 5>();
